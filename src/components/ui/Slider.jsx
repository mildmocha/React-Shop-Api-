...
export default function SimpleSlider() {
  ...
  return (
    <div className="slider_wrap">
      <Slider {...settings}>
        <div>
          <img className="pc" src="./images/notitle.png" alt="pc"/>
          <img className="mobile" src="./images/notitle.png" alt="mobile"/>
        </div>
        <div>
      ...
      <div className='absolute w-full top-2/3 md:top-1/2 text-center'>
        ...
        <p className=" text-black text-5xl md:text-4xl font-serif">Foundation</p>
      </div>
    </div>
  );
}